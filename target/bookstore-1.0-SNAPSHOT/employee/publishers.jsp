        ...
        <div class="content-wrapper">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control mb-2" id="myInput" onkeyup="myFunction()" placeholder="Yayınevini Adını Girerek Arama Yapın..">
                        ...
                        <tbody>
                            ...
                            for(int i=0;i<publishers.size();i++){
                                ...
                                <tr>
                                    ...
                                    <td><a href="delete-publisher.jsp?ID=<%=publishers.get(i).getID()%>" class="btn btn-danger" onclick="return confirm('Emin misin?')"><i class="icon-trash"></i> Sil</a></td>
                                </tr>
                            <%        
                                }
                            %>
