        ...
        <div id="layoutSidenav_content">
            <div class="m-2">
                <div class="card bg-success text-white mb-2">
                    <div class="card-body">Bendeki Kitap Sayısı:</div>
                ...
                <div class="card bg-primary text-white mb-2">
                    <div class="card-body">Kitap Sayısı:</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="card bg-info text-white mb-2">
                    <div class="card-body">Yazar Sayısı:</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="card bg-danger text-white mb-2">
                    <div class="card-body">Kategori Sayısı:</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="card bg-warning text-white mb-2">
                    <div class="card-body">Yayınevi Sayısı:</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
